...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white font-sans flex items-center justify-center px-6 selection:bg-purple-600">
      <div className="max-w-md w-full p-8 rounded-2xl bg-slate-900 border border-slate-800 shadow-2xl relative my-8">
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold mb-2">Crie sua conta turbo</h2>
          <p className="text-slate-400 text-sm">Preencha os campos para iniciar sua jornada de estudos</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <label className="block text-xs font-semibold uppercase tracking-wider text-slate-400 mb-2">
              Nome da Empresa ou Estudo (Workspace)
            </label>
            <input
              type="text"
              value={orgName}
              ...
              className="w-full bg-slate-950 border border-slate-850 focus:border-purple-600 rounded-xl px-4 py-3 text-sm focus:outline-none transition-all"
              placeholder="Ex: Meus Estudos ou Minha Empresa"
              required
            />
          </div>
